...
if __name__ == '__main__':
    ...
    # paths
    # parser.add_argument("--data_path", type=str, default="./data/btad/BTech_Dataset_transformed", help="path to test dataset")
    parser.add_argument("--data_path", type=str, default="./data/DAGM", help="path to test dataset")
    parser.add_argument("--save_path", type=str, default='./results/', help='path to save results')
    parser.add_argument("--checkpoint_path", type=str, default='./checkpoint/noForzen/hsf/epoch_15.pth', help='path to checkpoint')
    # model
